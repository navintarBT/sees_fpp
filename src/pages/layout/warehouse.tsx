...
const Warehouse = () => {
  ...
  const warehouseButtons = [
    ...
    { label: '返却構成登録', path: '/factory/set-return-configuration', className: 'mockup-yellow' },
    ...
    { label: '備品管理', path: '/factory/Equipment', className: 'mockup-orange' },
    { label: '束登録', path: '/factory/BundlePage', className: 'mockup-pink' },
  ] as const
